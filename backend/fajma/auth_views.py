    ...
    def post(self, request):
        try:
            ...
            if refresh_token:
                ...
                # Invalider également le token d'accès associé
                # En blacklistant le refresh token, les nouveaux access tokens ne pourront plus être générés
                # Le token d'accès actuel expirera naturellement selon ACCESS_TOKEN_LIFETIME
